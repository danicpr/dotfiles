...
## Project-Specific Instruction Loading

When working in a repository that contains `.omp/AGENTS.md`, load and follow
that file before taking action.

Treat this file as project-scoped instructions, not as general instructions
for unrelated repositories. If a project instruction conflicts with a higher-
priority system or user instruction, follow the higher-priority instruction and
